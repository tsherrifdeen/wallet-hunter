...
const Nav = () => {
  ...
  return (
    <div className="flex justify-between p-6 max-w-[1200px] mx-auto w-full items-center border-b-slate-600 border-b">
      ...
      {isOpen ? (
        <div className="absolute z-10 w-1/3 p-3 transition-all border border-gray-600 rounded-lg bg-slate-600 bg-opacity-15 border-opacity-20 backdrop-blur-lg top-20 right-5 ">
